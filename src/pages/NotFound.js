...
const NotFound = () => {
  return (
    <div class="flex justify-center flex-grow mt-64">
      <div class="mt-16 font-montserrat">
        ...
        <p class="flex items-center justify-center whitespace-no-wrap overflow-x-auto text-indigo-600 font-semibold sm:text-md md:text-2xl lg:text-2xl xl:text-3xl">
          Não encontrado
        </p>
      </div>
    </div>
